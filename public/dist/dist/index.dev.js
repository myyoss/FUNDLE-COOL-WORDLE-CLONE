        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            if (data.username !== 'Guest') {
              ...
              greetings = timeOfDay();
              document.querySelector(".hello").innerHTML = "&nbsp;&nbsp;".concat(greetings, " <span style=\"color: #538d4e;\">&nbsp;").concat(storeUserName, "</span>");
              logOutDisply = document.querySelector("#logOutDisply");
              logOutDisply.style.display = 'block';
              getNewWord();
            } else {
              _greetings = timeOfDay();
              document.querySelector(".hello").innerHTML = "&nbsp;&nbsp;".concat(_greetings, " <span style=\"color: #538d4e;\">&nbsp;", "Guest", "</span>");
